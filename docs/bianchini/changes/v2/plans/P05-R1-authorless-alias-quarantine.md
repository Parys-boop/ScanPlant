# P05-R1 — Elegibilidade e quarentena de aliases homônimos

Uma unidade futura delimitada à regra de U-201, sem reescrever P05 histórico.
Perfil standard; risco operacional low, artefato local reversível sem consumidores ativos.
Policy parser: grouped/plan_gate, mutation not_required, 3 fix rounds por seam
offline-manifest-contract, rodada formal acumulada 0. Estados anteriores e release preservados.
Ler somente este plano e suas specs; execução não depende de escopo bruto ou backup antigo.
